...
E_subtract = float(snakemake.wildcards.E_subtract)
...
for i in range(steps_initial):
    ...
    with tl.time_section("integration step"):
        params_after = integrator(params_before, i * delta_initial, delta_initial, F_imagt, (model, sample_space, ainvsquared, E_subtract, regulator, svd_cut, elmr_store))
